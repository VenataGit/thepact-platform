...
var HIST_TABS = [
  ...
  { id: 'bc_vp', icon: '🎬', label: 'Video Production',
    desc: 'Целият вътрешен проект Video Production в Basecamp: карти (създаване, местене между отдели, чекнати стъпки), Docs & Files (документи и файлове — създаване, редакция, преименуване, <strong>изтриване</strong>) и Message Board. За текста и сроковете на самите карти виж табовете „Текст"/„Срокове". Обходът за Docs&amp;Files/Message Board е веднъж на час (за да засече изтритото трябва пълен обход); картите — на 15 минути.' },
  { id: 'bc_clients', icon: '🧑‍💼', label: 'Клиенти',
    desc: 'Всички останали проекти в Basecamp (клиентски): Docs & Files, Message Board и задачи (to-dos) — създаване, редакция, завършване и <strong>изтриване</strong>. Засича се веднъж на час (пълен обход, за да хване и изтритото).' },
