...
function kpAdminRender() {
  ...
  html += '<div class="sg-section">' +
    ...
    '<div class="sg-kp-rows">' +
      ...
      kpAdmNumRow('kp_days_lead_before_due', 'Изпреварване на срока', s.kp_days_lead_before_due || '5', 'картата излиза поне толкова работни дни ПРЕДИ срока за готов план · важи по-ранната от двете дати') +
